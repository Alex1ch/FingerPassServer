...
namespace FingerPassServer
{
    class HashFuncs
    {
        private static SecureRandom _cryptoRandom = new SecureRandom();
        ...
        public static byte[] PBKDF2_SHA256_GetHash(string password, byte[] salt, int iterations, int hashByteSize)
        {
